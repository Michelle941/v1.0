<style>
    ...
    .hidden-div2{ display:none; margin-bottom:0;}
</style>
<button onclick="getElementById('hidden-div2').style.display = 'block'" style="margin-bottom: 1px"> Buy Tickets Now </button>

<div class="hidden-div2" id="hidden-div2"><?php echo $eventbrite;?></div>
<br><br><br><br><br>
