<section id="about-story">
	...
	</div><!-- margins: about story photo -->

	<div class="margins-60 story-open">

		<p>
			Approached by the CIA to build a spaceship for exploration of Uranus, we used <br> our top-level resources instead to invent a new way to party and make friends.
		</p>
...
<section id="about-howitworks">
	...
	<div class="margins-80">
		...
		<p>
		Keep in touch with other members through messaging. Sending a message is free, but reading a message is not.  You need to upgrade your membership to read messages from other members.  It’s only $10 a month and membership fees keep this website ad-free! <br> Yee-haw!!!!
		</p>
