...
<div class="form" style="text-align: center; width: 800px;margin: 0 auto">
    ...
    $form = ActiveForm::begin([
        ...
        <br>
        <br>
        <p>By clicking Buy Tickets, i agree to one-time payment of $<?php echo number_format($total, 2, '.', '')?> in accordance with the <a class="terms" href="page/terms" target="_blank">TERMS OF USE</a></p>
    <?php ActiveForm::end(); ?>
</div>
<?php
$js = <<<JS
