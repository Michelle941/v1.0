...
<!--			<a href="--><?php //echo Url::to(['/user/send-mail', 'id' => $user->id]); ?><!--" class="fancybox fancybox.ajax noline"><div class="button-follow noline">Message</div></a>-->
			...
			<div id="js-follow">
                    <?php if(Yii::$app->user->isGuest){
                       ?>
                       <a href="#login" class="fancybox noline"><div class="button-follow noline">Follow</div></a>
                       <?php
                    }
                    elseif(Yii::$app->user->getId() == $user->id)
                    {
                    ...
                    elseif(\app\models\Following::checkFollow($user->id)) {
                        ?>
                        <div class="button-follow noline">Following</div>
                        <?php
                    }
                    else {
                    ?>
                        <a href="<?=Url::to(['/user/follow', 'id' => $user->id]);?>" class="js-follow-link noline"><div class="button-follow">Follow</div></a>
                    <?php };?>
                    </div>
		...
		<?php
                if(is_null($user->org_user) && is_numeric($user->relation_status)){ ?>
				<span>
		...
		<div class="profile-right-under pts-bottom-right equalize">
