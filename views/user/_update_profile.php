	...
	<div class="margins-80">
		...
		<div class="profile-update-toggles-left">
			...
			<div class="input__radio input__radio--2">
                            ...
                            {
                                echo '<input type="radio" name="User[relation_status]" value="'.$k.'" id="'.$relation.'" uncheckValue="null" '.(($model->relation_status == $k)? 'checked' : '').'><label for="'.$relation.'">'.$relation.'</label>';
                            }
                            ?>
                        </div>
		...
		<div class="profile-update-toggles-right">
			...
			<div class="input__radio input__radio--2">
                            ...
                            {
                                echo '<input type="radio" name="User[gender]" value="'.$k.'" id="'.$gender.'" uncheckValue="null" '.(($model->gender == $k)? 'checked' : '').'><label for="'.$gender.'">'.$gender.'</label>';
                            }
                            ?>
                        </div>
