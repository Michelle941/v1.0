...
<?php foreach($membersNoTagline as $mnt):?>
<div class="party-single-avatars-big-cell">
<a href="<?= Url::to(['site/member', 'id' => 'qt'.$mnt['id']]); ?>" class="noline">
<div class="party-single-avatars-big-circle" style="background-image: url(' /upload/350x350_square<?= $mnt['avatar']; ?> ');"></div>
</a>
</div>
<?php endforeach;?>
<div class="clearfix"></div>
